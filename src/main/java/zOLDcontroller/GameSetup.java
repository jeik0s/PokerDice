...
import zOLDview.View;

/**
 * Main controller class responsible for controlling data flow between model and
 * view
 *
...
public class GameSetup {
     ...
     *
     * @param mainArgs parameters from main function, that should defined as
     * dice polls
     */
